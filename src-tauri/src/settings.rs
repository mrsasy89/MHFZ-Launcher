...
/// Find the INI file in the given folder.
/// If `mhf.ini` exists, return it; otherwise return the first file with a .ini extension.
/// If no .ini file exists, return `mhf.ini` (which may not exist).
